...
export const PREDICTION_MARKET_ADDRESS =
  (process.env.NEXT_PUBLIC_PREDICTION_MARKET_ADDRESS || "0x192403dE32d297e58f3CdbCADbfBfd2fd16ff2F2").trim();
...
export const GOVERNANCE_TOKEN_ADDRESS =
  (process.env.NEXT_PUBLIC_GOVERNANCE_TOKEN_ADDRESS || "0x0000000000000000000000000000000000000000").trim();

export const PARAMETER_REGISTRY_ADDRESS =
  (process.env.NEXT_PUBLIC_PARAMETER_REGISTRY_ADDRESS || "0x0000000000000000000000000000000000000000").trim();

export const MARKET_AGENT_ADDRESS =
  (process.env.NEXT_PUBLIC_MARKET_AGENT_ADDRESS || "0x0000000000000000000000000000000000000000").trim();
